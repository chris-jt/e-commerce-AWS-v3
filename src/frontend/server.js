...
let productsEndpoint = process.env.PRODUCTS_SERVICE_URL || '/api/products';
let shoppingCartEndpoint = process.env.SHOPPING_CART_SERVICE_URL || '/api/cart';
let merchandiseEndpoint = process.env.MERCHANDISE_SERVICE_URL || '/api/merchandise';
